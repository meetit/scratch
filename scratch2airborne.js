...
var d = new RollingSpider({uuid:"2b4afeed53364fa9be6301b8abf65472"});
...
client.connect(SCRATCH_PORT, '127.0.0.1', function() {
  console.log('Connected to scratch port, listening to any related commands sent from scratch...');
});
